...
| Day 47 | ⏳ | 正则表达式与日志解析 | 待生成 |
| Day 48 | ⏳ | 网络编程与 HTTP 客户端 | 待生成 |
| Day 49 | ⏳ | 数据库交互（SQLite） | 待生成 |
| Day 50 | ⏳ | 并发编程 | 待生成 |
| Day 51 | ⏳ | CLI 工具开发 | 待生成 |
| Day 52 | ⏳ | 装饰器与高级技巧 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 70 | ⏳ | MySQL 基础与架构 | 待生成 |
| Day 71 | ⏳ | MySQL 性能调优 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 76 | ⏳ | Docker 简介与安装 | 待生成 |
| Day 77 | ⏳ | Docker 镜像基础 | 待生成 |
| Day 78 | ⏳ | Dockerfile 进阶构建 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 90 | ⏳ | Kubernetes 简介与架构 | 待生成 |
| Day 91 | ⏳ | Kubernetes Pod | 待生成 |
| Day 92 | ⏳ | Kubernetes Deployment | 待生成 |
| Day 93 | ⏳ | Kubernetes StatefulSet | 待生成 |
| Day 94 | ⏳ | DaemonSet & Job/CronJob | 待生成 |
| Day 95 | ⏳ | Kubernetes Service | 待生成 |
| Day 96 | ⏳ | Kubernetes Ingress | 待生成 |
| Day 97 | ⏳ | ConfigMap 与 Secret | 待生成 |
| Day 98 | ⏳ | 存储 — PV/PVC/StorageClass | 待生成 |
| Day 99 | ⏳ | RBAC 权限管理 | 待生成 |
| Day 100 | ⏳ | 调度器与亲和性 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 105 | ⏳ | AWS 简介与账户管理 | 待生成 |
| Day 106 | ⏳ | EC2 基础 | 待生成 |
| Day 107 | ⏳ | VPC 网络 | 待生成 |
| Day 108 | ⏳ | S3 对象存储 | 待生成 |
| Day 109 | ⏳ | RDS 数据库 | 待生成 |
| Day 110 | ⏳ | ELB 负载均衡 | 待生成 |
| Day 111 | ⏳ | Auto Scaling | 待生成 |
| Day 112 | ⏳ | CloudWatch 监控 | 待生成 |
| Day 113 | ⏳ | Route 53 DNS | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 126 | ⏳ | Ansible 简介 | 待生成 |
| Day 127 | ⏳ | Ansible 基础 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 147 | ⏳ | CI/CD 概念与 GitOps | 待生成 |
| Day 148 | ⏳ | GitHub Actions | 待生成 |
| Day 149 | ⏳ | GitLab CI | 待生成 |
| Day 150 | ⏳ | Jenkins | 待生成 |
| Day 151 | ⏳ | 构建工具集成 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 161 | ⏳ | LLM Ops 概述 | 待生成 |
| Day 162 | ⏳ | GPU 基础设施运维 | 待生成 |
| Day 163 | ⏳ | 模型推理部署 | 待生成 |
...
| 天数 | 状态 | 学习主题 | 文档链接 |
|------|------|---------|---------|
| Day 173 | ⏳ | On-Call 实践 | 待生成 |
| Day 174 | ⏳ | 事故管理与 RCA | 待生成 |
| Day 175 | ⏳ | SLO 与错误预算 | 待生成 |
| Day 176 | ⏳ | 容量规划 | 待生成 |
| Day 177 | ⏳ | 灾备与恢复 | 待生成 |
| Day 178 | ⏳ | 成本优化 | 待生成 |
...
|------|------|---------|---------|
| Day 187 | ⏳ | 简历优化 | 待生成 |
| Day 188 | ⏳ | 面试题 — Linux 与网络 | 待生成 |
| Day 189 | ⏳ | 面试题 — 容器与 K8s | 待生成 |
| Day 190 | ⏳ | 面试题 — 运维与系统设计 | 待生成 |
| Day 191 | ⏳ | 认证准备 | 待生成 |
| Day 192 | ⏳ | 软技能 | 待生成 |
| Day 193 | ⏳ | 职业规划 | 待生成 |
| Day 194 | ⏳ | 新起点 — 开始投递简历 | 待生成 |
