...
### 1. Kubernetes Service — 核心概念

Kubernetes Service 是 SRE 工程师必须掌握的重要技能。

#### 1.1 基础知识

- 理解Kubernetes Service的基本原理和架构
- 掌握常用命令和操作方式
- 能够在实际工作场景中应用

#### 1.2 SRE 实战场景

在生产环境中，Kubernetes Service的应用场景包括：
- **日常运维**：定期检查和维护
- **故障排查**：快速定位和解决问题
- **自动化**：编写脚本实现自动化管理
...
*由 SRE 学习计划自动生成 | 2026-05-02 13:42:14*  
